...
namespace BLL.ShipComponents
{
	public class RocketsComponent : ICharlieComponent
	{
		...
		public event EventHandler<RocketsRemovedEventArgs> RocketsModified = (
			sender,
			eventArgs
		) => { };
		...
		public int RemoveAllRockets()
		{
			...
			RocketsModified(
				this,
				new RocketsRemovedEventArgs { RocketsRemovedCount = rocketCountRemoved }
			);
