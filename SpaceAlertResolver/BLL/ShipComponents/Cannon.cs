...
namespace BLL.ShipComponents
{
	public abstract class Cannon : IAlphaComponent
	{
		...
		protected IList<ZoneLocation> AffectedZones
		{
			get { return affectedZones; }
		}
		protected IEnumerable<int> BaseAffectedDistances
		{
			get { return baseAffectedDistances; }
		}
		protected PlayerDamageType PlayerDamageType
		{
			get { return playerDamageType; }
		}
		...
		protected abstract IEnumerable<PlayerDamage> GetPlayerDamage(
		...
		protected Cannon(
			...
			int baseDamage,
			IEnumerable<int> baseAffectedDistances,
			PlayerDamageType playerDamageType,
			params ZoneLocation[] affectedZones
		)
		{
			this.source = source;
