...
namespace BLL.Players
{
	public static class PlayerActionFactory
	{
		public static PlayerAction CreatePlayerAction(
			PlayerActionType? firstAction,
			PlayerActionType? secondAction,
			PlayerActionType? bonusAction
		)
		{
		...
		public static IEnumerable<PlayerAction> CreateSingleActionList(
			IEnumerable<PlayerActionType?> actionTypes
		)
		{
			return actionTypes
		...
		[SuppressMessage("Microsoft.Design", "CA1006:DoNotNestGenericTypesInMemberSignatures")]
		public static IEnumerable<PlayerAction> CreateDoubleActionList(
			IList<PlayerActionType?> actionTypes
		)
		{
			...
			return firstActions.Zip(
				secondActions,
				(firstAction, secondAction) => new PlayerAction(firstAction, secondAction, null)
			);
		}
