...
namespace BLL.Threats.External
{
	...
	{
		public static IEnumerable<ExternalThreat> AllExternalThreats { get; } =
			new ExternalThreat[]
			{
				new EnergySnake(),
				new JumperB(),
		...
		private static IDictionary<string, Type> ThreatTypesById { get; } =
			AllExternalThreats.ToDictionary(threat => threat.Id, threat => threat.GetType());

		public static T CreateThreat<T>(string id)
			where T : ExternalThreat
		{
