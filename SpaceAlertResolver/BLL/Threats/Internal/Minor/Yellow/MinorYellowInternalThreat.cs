...
namespace BLL.Threats.Internal.Minor.Yellow
{
	public abstract class MinorYellowInternalThreat : MinorInternalThreat
	{
		...
		protected MinorYellowInternalThreat(int health, int speed, int timeAppears, IList<StationLocation> currentStations, PlayerAction actionType, ISittingDuck sittingDuck, int? accessibility = null)
