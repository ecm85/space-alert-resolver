...
{
	public abstract class HiddenTransmitter
		: SeriousRedInternalThreat,
			IThreatWithBonusThreat<ExternalThreat>
	{
		...
		public override bool NeedsBonusExternalThreat
		{
			get { return true; }
		}
		...
		{
			get { return 8 + (calledInThreat ? 0 : BonusThreat.PointsForDefeating); }
		}
