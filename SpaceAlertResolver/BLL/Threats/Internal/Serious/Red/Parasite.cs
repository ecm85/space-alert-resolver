...
namespace BLL.Threats.Internal.Serious.Red
{
	public class Parasite : SeriousRedInternalThreat
	{
		...
		protected override void PerformXAction(int currentTurn)
		{
			if (
				attachedPlayer != null
				&& !attachedPlayer.IsKnockedOut
				&& attachedPlayer.CurrentStation.StationLocation.IsOnShip()
			)
		...
		{
			var otherPlayersInStation = SittingDuck
				.GetPlayersInStation(attachedPlayer.CurrentStation.StationLocation)
		...
		public override bool CanBeTargetedBy(
			StationLocation stationLocation,
