	...
	public class PhasingAnomaly : SeriousYellowInternalThreat
	{
		...
		protected override void PerformXAction(int currentTurn)
		{
			SittingDuck.AddZoneDebuff(
				new[] { ZoneLocation.White },
				ZoneDebuff.DisruptedOptics,
				this
			);
		}
		...
		{
			SittingDuck.KnockOutPlayers(
				new[] { StationLocation.LowerWhite, StationLocation.UpperWhite }
			);
			Attack(3);
		}
