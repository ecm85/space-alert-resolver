...
namespace BLL.Threats.Internal.Serious.White
{
	public class Fissure : SeriousWhiteInternalThreat
	{
		...
		public override IList<StationLocation> DisplayOnTrackStations { get; } =
			new List<StationLocation> { StationLocation.UpperRed };
		public override IList<StationLocation> DisplayOnShipStations { get; } =
			new List<StationLocation> { StationLocation.UpperRed };
		...
		{
			SittingDuck.AddZoneDebuff(
				EnumFactory.All<ZoneLocation>(),
				ZoneDebuff.DoubleDamage,
				this
			);
		}
