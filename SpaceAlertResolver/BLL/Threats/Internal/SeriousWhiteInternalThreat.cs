...
namespace BLL.Threats.Internal
{
	public abstract class SeriousWhiteInternalThreat : SeriousInternalThreat
	{
		...
		protected SeriousWhiteInternalThreat(int health, int speed, int timeAppears, IList<StationLocation> currentStations, PlayerAction actionType, ISittingDuck sittingDuck) :
