...
namespace BLL.Threats.Internal
{
	...
	{
		public static IEnumerable<InternalThreat> AllInternalThreats { get; } =
			new InternalThreat[]
			{
				new BreachedAirlock(),
				new Driller(),
		...
		private static IDictionary<string, Type> ThreatTypesById { get; } =
			AllInternalThreats.ToDictionary(threat => threat.Id, threat => threat.GetType());

		public static T CreateThreat<T>(string id)
			where T : InternalThreat
		{
