...
namespace API.Models
{
	public class ThreatsByTypeModel
	{
		...
		public ThreatsByTypeModel(IEnumerable<ThreatModel> threats)
		{
			...
			SeriousThreats = threatsGroupedByType[ThreatType.SeriousExternal]
				.Concat(threatsGroupedByType[ThreatType.SeriousInternal])
				.ToList();
			MinorThreats = threatsGroupedByType[ThreatType.MinorExternal]
				.Concat(threatsGroupedByType[ThreatType.MinorInternal])
				.ToList();
		}
	}
}
