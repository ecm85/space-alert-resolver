...
namespace API.Models
{
	public static class ActionModelFactory
	{
		...
		{
			var matchingStandardAction = ActionModel
				.AllSingleActionModels.Concat(ActionModel.AllSelectableDoubleActionModels)
				.Concat(ActionModel.AllNonSelectableDoubleActionModels)
			...
			var matchingSpecializationAction =
				PlayerSpecializationActionModel.AllPlayerSpecializationActionModels.FirstOrDefault(
					actionModel =>
						action.FirstActionSegment.SegmentType == actionModel.FirstAction
						&& player.Specialization == actionModel.PlayerSpecialization
				);
			var matchingBonusAction =
				PlayerSpecializationActionModel.AllPlayerSpecializationActionModels.FirstOrDefault(
					actionModel =>
