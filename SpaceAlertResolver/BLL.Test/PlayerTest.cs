...
namespace BLL.Test
{
	...
	public static class PlayerTest
	{
		...
		public static void Test_ShiftAfterPlayerActions_MultipleTimesConsecutiveTurns()
		{
			...
			var expectedActions = PlayerActionFactory
				.CreateSingleActionList(
					new PlayerActionType?[]
					{
						PlayerActionType.Alpha,
						PlayerActionType.Bravo,
		...
		public static void Test_ShiftFromPlayerActions_NoBlanks()
		{
			...
			player.Actions.ElementAt(0).FirstActionSegment.SegmentStatus =
				PlayerActionStatus.Performed;
			player.Actions.ElementAt(1).FirstActionSegment.SegmentStatus =
				PlayerActionStatus.Performing;
		...
		{
			var player = new Player(
				PlayerActionFactory.CreateDoubleActionList(
					new PlayerActionType?[]
					{
						PlayerActionType.Alpha,
						null,
			...
			player.Actions.ElementAt(0).FirstActionSegment.SegmentStatus =
				PlayerActionStatus.Performed;
			player.Actions.ElementAt(0).SecondActionSegment.SegmentStatus =
				PlayerActionStatus.Performed;
			player.Actions.ElementAt(1).FirstActionSegment.SegmentStatus =
				PlayerActionStatus.Performed;
			player.Actions.ElementAt(1).SecondActionSegment.SegmentStatus =
				PlayerActionStatus.Performed;
			player.ShiftAfterPlayerActions(2);
			var expectedActions = PlayerActionFactory
				.CreateDoubleActionList(
					new PlayerActionType?[]
					{
						PlayerActionType.Alpha,
						null,
				...
				.ToList();
			expectedActions.ElementAt(0).FirstActionSegment.SegmentStatus =
				PlayerActionStatus.Performed;
			expectedActions.ElementAt(0).SecondActionSegment.SegmentStatus =
				PlayerActionStatus.Performed;
			expectedActions.ElementAt(1).FirstActionSegment.SegmentStatus =
				PlayerActionStatus.Performed;
			expectedActions.ElementAt(1).SecondActionSegment.SegmentStatus =
				PlayerActionStatus.Performed;
			AssertActionAreEqual(expectedActions.ToList(), player.Actions.ToList());
		}
		...
		private static void AssertActionAreEqual(
			IList<PlayerAction> expected,
			IList<PlayerAction> actual
		)
		{
			...
			{
				Assert.AreEqual(
					expected[i].FirstActionSegment.SegmentType,
					actual[i].FirstActionSegment.SegmentType,
					$"Action {i}"
				);
				Assert.AreEqual(
					expected[i].FirstActionSegment.SegmentStatus,
					actual[i].FirstActionSegment.SegmentStatus,
					$"Action {i}"
				);
				Assert.AreEqual(
					expected[i].SecondActionSegment.SegmentType,
					actual[i].SecondActionSegment.SegmentType,
					$"Action {i}"
				);
				Assert.AreEqual(
					expected[i].SecondActionSegment.SegmentStatus,
					actual[i].SecondActionSegment.SegmentStatus,
					$"Action {i}"
				);
			}
		}
