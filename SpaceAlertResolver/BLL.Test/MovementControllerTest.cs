	...
	public static class MovementControllerTest
	{
		...
		public static void Test_Path_ChangeDecks()
		{
			Test_Path_Helper(
				StationLocation.UpperBlue,
				StationLocation.LowerBlue,
				new List<StationLocation> { StationLocation.LowerBlue }
			);
			Test_Path_Helper(
				StationLocation.LowerWhite,
				StationLocation.UpperWhite,
				new List<StationLocation> { StationLocation.UpperWhite }
			);
		}
		...
		public static void Test_Path_Move()
		{
			...
			Test_Path_Helper(
				StationLocation.UpperWhite,
				StationLocation.UpperBlue,
				new List<StationLocation> { StationLocation.UpperBlue }
			);
		}
		...
		public static void Test_Path_MoveAndChangeDecks()
		{
			Test_Path_Helper(
				StationLocation.LowerWhite,
				StationLocation.UpperBlue,
				new List<StationLocation> { StationLocation.LowerBlue, StationLocation.UpperBlue }
			);

			Test_Path_Helper(
				StationLocation.UpperWhite,
				StationLocation.LowerRed,
				new List<StationLocation> { StationLocation.UpperRed, StationLocation.LowerRed }
			);
		}

		private static void Test_Path_Helper(
			StationLocation toStation,
			StationLocation fromStation,
			List<StationLocation> expectedPath
		)
		{
