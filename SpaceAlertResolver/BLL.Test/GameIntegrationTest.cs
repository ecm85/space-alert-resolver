	...
	public static class GameIntegrationTest
	{
		...
		public static void JustAFighterNoActions()
		{
			var players = Enumerable
				.Range(0, 1)
				.Select(index => new Player(new List<PlayerAction>(), 0, PlayerColor.Blue))
				.ToList();
		...
		public static void EzraCampaign1Mission1()
		{
			var players = new List<Player>
			{
				...
				new Player(
					...
					3,
					PlayerColor.Red,
					PlayerSpecialization.DataAnalyst
				),
			};
		...
		public static void EzraCampaign1Mission2()
		{
			var players = new List<Player>
			{
				...
				new Player(
					...
					1,
					PlayerColor.Green,
					PlayerSpecialization.PulseGunner
				),
				new Player(
					PlayerActionFactory.CreateSingleActionList(
						new PlayerActionType?[]
		...
		private static Player CreateYellowPlayerDoubleActionsCampaignMission1()
		{
			...
			var yellowPlayer = new Player(
				...
				2,
				PlayerColor.Yellow,
				PlayerSpecialization.SpecialOps
			);
			return yellowPlayer;
		}
